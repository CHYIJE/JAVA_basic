...
//     // + 캐릭터 공격력* 1.25/1.45/1.55/1.65/1.85/ 2.05
...
// class Tempest extends Skill {
//     public Tempest(Champ champ){
//         super("강철폭풍", champ);
//     }
...
//         int damage = (int)(20 + (15 * (point - 1)) + (this.champ.ad * 1.05));
